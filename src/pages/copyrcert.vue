    ...
    <div class="row justify-content-md-center">
      <div class="col-md-7">
        <div class="wrap">
          ...
          <div class="content">
            版权认证是一个基于区块链的文件存证平台，文件的持有人和使用人可以通过平台验证文件是否被篡改
          </div>
          <div class="btns">
            <div class="container">
              <div class="row justify-content-md-center">
                <div class="col-md-5">
                  <button type="button" class="btn btn-info btn-copyr-cert">版权认证</button>
                  <button type="button" class="btn btn-light btn-file-check">文件验证</button>
                </div>
              </div>
            </div>
          </div>
